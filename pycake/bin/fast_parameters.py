...
parameters = {
        ...
        "V_reset_range":range(200,800,100),      # 7 steps
        "E_synx_range": range(650,1100,100),     # 5 steps
        "E_syni_range": range(350,750,100),      # 5 steps
        "E_l_range":    range(500,900,100),      # 4 steps
        "V_t_range":    range(600,900,100),      # 4 steps
        "I_gl_range":   range(200,1500,200),     # 7 steps
